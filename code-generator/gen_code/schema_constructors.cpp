...
warehouse::warehouse (int _w_id,char _w_name[11],char _w_street_1[21],char _w_street_2[21],char _w_city[21],char _w_state[3],char _w_zip[10],uint64_t _w_tax,uint64_t _w_ytd)
{
	w_id = _w_id;
...
district::district() {count=0;}

district::district (int _d_id,int _d_w_id,char _d_name[11],char _d_street_1[21],char _d_street_2[21],char _d_city[21],char _d_state[3],char _d_zip[10],uint64_t _d_tax,uint64_t _d_ytd,int _d_next_o_id)
{
	d_id = _d_id;
	d_w_id = _d_w_id;
...
history::history (int _h_c_id,int _h_c_d_id,int _h_c_w_id,int _h_d_id,int _h_w_id,uint64_t _h_date,uint64_t _h_amount,char _h_data[25])
{
	h_c_id = _h_c_id;
	h_c_d_id = _h_c_d_id;
	h_c_w_id = _h_c_w_id;
...
order::order (int _o_id,int _o_d_id,int _o_w_id,int _o_c_id,uint64_t _o_entry_d,int _o_carrier_id,uint64_t _o_ol_cnt,uint64_t _o_all_local)
{
	o_id = _o_id;
	o_d_id = _o_d_id;
	o_w_id = _o_w_id;
...
orderline::orderline() {count=0;}

orderline::orderline (int _ol_o_id,int _ol_d_id,int _ol_w_id,int _ol_number,int _ol_i_id,int _ol_supply_w_id,uint64_t _ol_delivery_d,uint64_t _ol_quantity,uint64_t _ol_amount,char _ol_dist_info[25])
{
	ol_o_id = _ol_o_id;
	ol_d_id = _ol_d_id;
	ol_w_id = _ol_w_id;
...
item::item (int _i_id,int _i_im_id,char _i_name[25],uint64_t _i_price,char _i_data[51])
{
	i_id = _i_id;
	i_im_id = _i_im_id;
...
stock::stock (int _s_i_id,int _s_w_id,uint64_t _s_quantity,char _s_dist_01[25],char _s_dist_02[25],char _s_dist_03[25],char _s_dist_04[25],char _s_dist_05[25],char _s_dist_06[25],char _s_dist_07[25],char _s_dist_08[25],char _s_dist_09[25],char _s_dist_10[25],uint64_t _s_ytd,uint64_t _s_order_cnt,uint64_t _s_remote_cnt,char _s_data[51])
{
	s_i_id = _s_i_id;
	s_w_id = _s_w_id;
